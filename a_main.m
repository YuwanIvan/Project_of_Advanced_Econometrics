...
disp('----------------------------');
disp('INTC');
data=csvread('hhs_data\INTC.csv');
date=data(:,1);
ocret=data((date<20080000),2);
ocret_out=data((date>20080000),2);
x=data((date<20080000),3);
...
disp('----------------------------');
disp('MSFT');
data=csvread('hhs_data\MSFT.csv');
date=data(:,1);
ocret=data((date<20080000),2);
ocret_out=data((date>20080000),2);
x=data((date<20080000),3);
