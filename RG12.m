function [thetah, se, lrx, lr, pai, rho, rho_plus, rho_mins, h, z, u, Hmat, Jmat] = RG12(ret, x, print)
    ...
    [thetah, ~, ~, ~, ~ , ~, hess]=fmincon(@(theta) -RG12_logL(theta,ret,x), theta0, A, B, [], [], [], [], [], options);
    Hmat = hess/T;
